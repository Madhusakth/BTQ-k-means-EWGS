...
__all__ = ['resnet20_quant', 'resnet20_fp', 'resnet56_quant', 'resnet56_fp']
...
def resnet56_fp(args):
    return ResNet(BasicBlock, [9, 9, 9], args)

def resnet56_quant(args):
    return ResNet(QBasicBlock, [9, 9, 9], args)
